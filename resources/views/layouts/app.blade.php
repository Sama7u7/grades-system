...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] dark:text-white">
    ...
    <div class="grid grid-cols-5 grid-rows-5 gap-4">
        <div class="row-span-5 ">
            ...
            <aside id="default-sidebar"
                ...
                aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 rounded-3xl ">
                    ...
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="#"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Registrar Usuarios</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="col-span-4">
                    <nav class="bg-white border-gray-200 dark:bg-gray-900 rounded-3xl">
        ...
        <div class="col-span-4 row-span-4 col-start-2 row-start-2">Contenido
            <main>
                @yield('content')
            </main>
        </div>
